    ...
    def _check_files(self) -> bool:
        ...
        if Path(self.constants.payload_local_binaries_root_path_dmg).exists():
            ...
            output = subprocess.run(
                [
                    "/usr/bin/hdiutil", "attach", "-noverify", self.constants.payload_local_binaries_root_path_dmg,
        ...
        logging.info("Failed to locate PatcherSupportPkg resources, this copy of OpenCore Legacy Patcher is likely corrupted.")
