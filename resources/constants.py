...
class Constants:
    def __init__(self) -> None:
        ...
        self.copyright:                       str = "Copyright © 2020-2024 Dortania"
        ...
        self.app_url:                         str = "https://nightly.link/repository_placeholder/workflows/build/branch_placeholder/OpenCore%20Legacy%20Patcher.app.zip"
