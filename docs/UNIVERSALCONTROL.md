...
SMBIOS       | Wi-Fi version | Bluetooth version | Universal Control out of box          | Comment
-------------|---------------|-------------------|--------------------------------------|------------------------------------------------------------------------------------------------
`MacBook5,1` | Wi-Fi 4       | Bluetooth 2.0 EDR | <span style="color:red">NO</span>    | Use a Broadcom USB Bluetooth 4.0+ Dongle.
`MacBook5,2` | ^^            | Bluetooth 2.1 EDR | ^^                                   | Replace stock AirPort card with an mPCIE + USB Connector Adapter board with a BCM94360CS2 card.
`MacBook6,1` | ^^            | ^^                | ^^                                   | Replace stock AirPort card with a BCM94331PCIEBT4CAX/BCM94331PCIEBT4 card.
`MacBook7,1` | ^^            | ^^                | ^^                                   | ^^
`MacBook8,1` | ^^            | Bluetooth 4.2     | <span style="color:green">YES</span> | Universal Control will work.
...
SMBIOS          | Wi-Fi version | Bluetooth version | Universal Control out of box         | Comment
----------------|---------------|-------------------|--------------------------------------|-----------------------------------------------------------------------
`MacBookAir2,1` | Wi-Fi 4       | Bluetooth 2.1 EDR | <span style="color:red">NO</span>    | Use a Broadcom USB Bluetooth 4.0+ Dongle.
`MacBookAir3,1` | ^^            | ^^                | ^^                                   | Replace stock AirPort card with a BCM94360CS2 card.
`MacBookAir3,2` | ^^            | ^^                | ^^                                   | ^^
`MacBookAir4,1` | ^^            | Bluetooth 4.0     | <span style="color:green">YES</span> | Universal Control will work.
`MacBookAir4,2` | ^^            | ^^                | ^^                                   | ^^
`MacBookAir5,1` | ^^            | ^^                | ^^                                   | ^^
`MacBookAir5,2` | ^^            | ^^                | ^^                                   | ^^
`MacBookAir6,1` | Wi-Fi 5       | ^^                | ^^                                   | ^^
`MacBookAir6,2` | ^^            | ^^                | ^^                                   | ^^
...
SMBIOS           | Wi-Fi version | Bluetooth version | Universal Control out of box         | Comment
-----------------|---------------|-------------------|--------------------------------------|------------------------------------------------------------------------------------------------
`MacBookPro4,1`  | Wi-Fi 4       | Bluetooth 2.1 EDR | <span style="color:red">NO</span>    | Replace stock AirPort card with an mPCIE + USB Connector Adapter board with a BCM94360CS2 card.
...
`MacBookPro8,1`  | ^^            | ^^                | ^^                                   | Replace stock AirPort card with a BCM94331PCIEBT4CAX/BCM94331PCIEBT4 card.
`MacBookPro8,2`  | ^^            | ^^                | ^^                                   | ^^
`MacBookPro9,1`  | ^^            | Bluetooth 4.0     | <span style="color:green">YES</span> | Universal Control will work.
`MacBookPro9,2`  | ^^            | ^^                | ^^                                   | ^^
`MacBookPro10,1` | ^^            | ^^                | ^^                                   | ^^
`MacBookPro10,2` | ^^            | ^^                | ^^                                   | ^^
`MacBookPro11,1` | Wi-Fi 5       | ^^                | ^^                                   | ^^
`MacBookPro11,2` | ^^            | ^^                | ^^                                   | ^^
`MacBookPro11,3` | ^^            | ^^                | ^^                                   | ^^
`MacBookPro11,4` | ^^            | Bluetooth 4.2     | <span style="color:red">NO</span>    | Hardware supports UC.<br>[**Spoofing required.**](#blacklisted-models)
`MacBookPro11,5` | ^^            | ^^                | ^^                                   | ^^
`MacBookPro12,1` | ^^            | ^^                | ^^                                   | ^^
:::
...
SMBIOS       | Wi-Fi version | Bluetooth version | Universal Control out of box          | Comment
-------------|---------------|-------------------|--------------------------------------
`Macmini3,1` | Wi-Fi 4       | Bluetooth 2.1 EDR | <span style="color:red">NO</span>     | Upgrade requires some heavy electrical and case modifications, so instead used a Broadcom USB Bluetooth 4.0+ Dongle.
`Macmini4,1` | ^^            | ^^                | ^^
`Macmini5,1` | ^^            | Bluetooth 4.0     | <span style="color:#green">YES</span> | Universal Control will work.
`Macmini5,2` | ^^            | ^^                | ^^
`Macmini5,3` | ^^            | ^^                | ^^
`Macmini6,1` | ^^            | ^^                | ^^
`Macmini6,2` | ^^            | ^^                | ^^
`Macmini7,1` | Wi-Fi 5       | ^^                | <span style="color:red">NO</span>     | Hardware supports UC. <br> [**Spoofing required.**](#blacklisted-models)
...
SMBIOS   | Wi-Fi/BT version | Universal Control out of box | Comment
---------|-----------------|------------|--------
...
* Note: Some older Mac Pro configurations may not have shipped with a Wi-Fi card in the base model
...
Name | Native SMBIOS | Spoof SMBIOS
------------|---------------|-------------
...
iMac Late 2015 21" | iMac16,x | i`Mac19,2`
...
iMac Late 2015 21" | iMac16,x | i`Mac18,2`
Mac mini Late 2014  | Macmini7,x | `MacMini8,1`
Mac Pro Late 2013 | MacPro6,x | `MacPro7,1`
...
MacBook Pro Mid 2015 15"         | `MacBookPro11,4` / `5` | `MacBookPro13,3`
